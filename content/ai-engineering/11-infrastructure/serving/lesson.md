---
id: ai-11-infrastructure-serving
...
## Objectifs
- Comprendre Model serving & inference.
- Choisir une architecture adaptée à la charge.
- Mesurer fiabilité, latence et coût.

## Concept
L'infrastructure AI doit isoler les ressources coûteuses et les dépendances externes du reste de l'application. **Model serving & inference** se conçoit avec des limites explicites : concurrence, taille des requêtes, mémoire, durée d'exécution, quotas et capacité.
...
## Exercice
Dessine une architecture pour **Model serving & inference**. Donne au moins une limite de capacité, une métrique de saturation, une stratégie de reprise et une estimation du coût.
