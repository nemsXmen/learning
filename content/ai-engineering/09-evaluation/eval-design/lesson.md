---
id: ai-09-evaluation-eval-design
title: "Evaluation design & datasets"
slug: eval-design
...
## Objectifs
- Comprendre Evaluation design & datasets.
- Concevoir un comportement contrôlable.
- Mesurer qualité et risques.

## Concept
Un système agentique combine un modèle, un état et des outils. **Evaluation design & datasets** doit donc être traité comme un problème d'orchestration logicielle. Le modèle ne doit jamais obtenir implicitement une permission que le produit n'a pas explicitement accordée.
