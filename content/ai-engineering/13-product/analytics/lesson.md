...
## Objectifs
- Comprendre Product analytics & iteration.
- Choisir une approche proportionnée au problème.
- Construire des critères de succès mesurables.

## Concept
Une fonctionnalité AI doit résoudre un problème utilisateur, pas simplement exposer un modèle. **Product analytics & iteration** doit être relié à un contrat produit : qui utilise la fonctionnalité, quelle décision elle aide, quel niveau d'erreur est acceptable et quelle action humaine reste possible.
...
## Exercice
Écris une fiche produit pour **Product analytics & iteration** : utilisateur cible, problème, baseline, métriques, risques, contrôle humain et critères de lancement.
