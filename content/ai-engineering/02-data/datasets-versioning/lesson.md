---
id: ai-02-data-datasets-versioning
title: "Datasets, splits & versioning"
...
**Datasets, splits & versioning** s'étudie avec une boucle d'ingénierie : définir le contrat d'entrée/sortie, établir une baseline, mesurer sur des cas représentatifs, isoler les variables, tester les erreurs et les cas adverses, puis déployer avec des limites et de l'observabilité.
...
Construis une petite expérience sur **Datasets, splits & versioning**.
