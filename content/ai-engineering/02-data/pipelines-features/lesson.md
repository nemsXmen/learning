---
id: ai-02-data-pipelines-features
...
**Pipelines & feature engineering** s'étudie avec une boucle d'ingénierie : définir le contrat d'entrée/sortie, établir une baseline, mesurer sur des cas représentatifs, isoler les variables, tester les erreurs et les cas adverses, puis déployer avec des limites et de l'observabilité.
...
Construis une petite expérience sur **Pipelines & feature engineering**.
