---
id: typescript-module-26
title: TypeScript & JavaScript Runtime
slug: module-26
...
- Comprendre les notions essentielles de **TypeScript & JavaScript Runtime**.
...
TypeScript & JavaScript Runtime doit être abordé comme un contrat entre le code, le compilateur et les personnes qui le maintiennent. Commence par modéliser les données, préfère les types explicites aux hypothèses implicites et garde les frontières d'exécution sous contrôle.
...
const example: ModuleExample = { title: 'TypeScript & JavaScript Runtime', ready: true };
...
1. Crée une représentation typée de **TypeScript & JavaScript Runtime**, puis écris une fonction qui refuse une donnée invalide.
   ...
   const item: Item = { name: 'TypeScript & JavaScript Runtime', valid: true };
   ```
   :::
