...
- [x] `/` is static, server rendered, and renders all seven sections in both themes
- [x] Metadata, `sitemap.xml` and `robots.txt` are complete and exclude private routes
- [x] Copy makes no claim the product cannot back; no fabricated social proof
